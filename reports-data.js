...
window.REPORTS_DATA = {
  ...
  reports: [
    ...
    },
    {
      id: "report-015",
      type: "company",
      title: "诗董橡胶：天然橡胶周期底部修复，但仍不是轻资产复利股",
      subtitle: "Sri Trang Agro-Industry × 天然橡胶加工 × 手套反转期权",
      author: "NSC Research",
      date: "2026-05-20",
      ...
      status: "published",
      confidence: "中高",
      conclusion: "诗董橡胶是全球天然橡胶产业链里少数具备上游采购、加工、全球销售和手套制造一体化能力的公司。2025 年亏损说明手套产能过剩、洪灾/减值和库存周期仍会强烈扰动利润；2026Q1 转盈说明底部正在修复，但还不能把它视为高质量复利股。当前更适合纳入周期底部修复观察池，等待天然橡胶毛利率、手套利用率和经营现金流同步改善。",
      keyEvidence: [
        "2025 年收入约 THB 1134.78 亿，同比小幅下降，但归母净亏损约 THB 12.66 亿",
        "2026Q1 官方披露归母净利润约 THB 6.45 亿，天然橡胶和手套业务均有恢复迹象",
        "公司拥有天然橡胶采购、加工、销售和手套制造的一体化产业链，抗周期能力强于小型加工商",
        "估值不能只看单季年化 PE，应以 PB、保守净资产、库存质量和中周期 ROE 为核心"
      ],
      sections: [
        {
          title: "核心矛盾",
        ...
        {
          title: "估值纪律",
          content: "2025 年亏损后 PE 失真，单季利润年化也容易误导。更合适的估值锚是 PB、保守调整后净资产、中周期 ROE 和手套业务的盈亏平衡可见度。"
        },
        {
          title: "风险与跟踪指标",
