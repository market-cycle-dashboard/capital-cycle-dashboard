...
window.REPORTS_DATA = {
  ...
  reports: [
    ...
    },
    {
      ...
      status: "published",
      confidence: "中高",
      conclusion: "诗董橡胶是全球天然橡胶产业链里少数具备采购、加工、全球销售、手套制造和 EUDR 可追溯体系的公司。它的规模与资产真实，但 2025 年亏损说明定价权有限、库存和手套周期足以吞掉规模优势。19.00 泰铢对应约 0.61 倍 PB，并非昂贵，但更像周期修复观察位；更好的赔率来自 14-16 泰铢或毛利率、手套利用率、经营现金流同步确认。",
      keyEvidence: [
        "2025 年收入 THB 1134.78 亿、归母净亏损 THB 12.66 亿，ROE 为 -2.55%，证明行业并非高 ROE 复利资产",
        "2026Q1 归母净利润 THB 6.45 亿，天然橡胶毛利率升至 8.7%，手套利用率升至 84.2%，但仍需连续验证",
        ...
        "估值以调整后 AV 和中周期 EPV 为闸门；14-16 泰铢区间比当前价更有资产保护"
      ],
      sections: [
        {
          title: "核心矛盾",
        ...
        {
          title: "估值纪律",
          content: "2025 年亏损后 PE 失真，单季利润年化也容易误导。更合适的估值锚是 PB、保守调整后净资产、中周期 ROE 和手套业务的盈亏平衡可见度。当前 19.00 泰铢不贵但安全边际一般，14-16 泰铢或连续两个季度现金流改善才更适合进攻。"
        },
        {
          title: "风险与跟踪指标",
