...
window.REPORTS_DATA = {
  ...
  reports: [
    ...
    },
    {
      id: "report-021",
      type: "company",
      title: "小商品城：义乌市场 1-7 区的资产价值、六区开发与商位溢价重估",
      subtitle: "一区至五区存量现金牛 × 六区全球数贸中心 × 一二手铺位溢价 × 数字贸易平台化验证",
      author: "NSC Research",
      date: "2026-08-25",
      tags: ["小商品城", "600415.SH", "义乌", "全球数贸中心", "专业市场", "A股"],
      company: "小商品城",
      industry: "商贸服务与专业市场",
      market: "A股",
      status: "published",
      confidence: "中高",
      conclusion: "小商品城的核心价值不在传统意义上的商铺面积，而在义乌全球小商品贸易网络的组织权。一区到五区是存量现金牛，六区/全球数贸中心是业态升级和成长试验场，七区或后续扩展只能作为远期期权。12.17 元附近已经部分反映六区成熟、数字贸易和高分红预期；新买入更舒服的安全边际在 9-10 元，8-9 元进入深度价值区。",
      keyEvidence: [
        "2025 年收入 199.27 亿元、归母净利润 42.04 亿元、扣非归母净利润 38.93 亿元，加权 ROE 17.53%",
        "一区到五区经营品类、成熟度和二手铺位溢价差异明显，不能把小商品城简单当成统一租金资产",
        "全球数贸中心总建筑面积约 125 万平方米、市场板块约 41 万平方米，定位时尚珠宝、创意潮玩、智能装备等新行业",
        "义乌购转租转让样本显示，老市场核心商位仍存在显著二手溢价，六区仍处价格发现期",
        "当前约 667 亿元市值接近传统 EPV 上沿，必须由六区成熟和数字贸易服务证明利润中枢上移"
      ],
      sections: [
        {
          title: "核心矛盾",
          content: "小商品城不是普通商业物业公司，而是义乌全球小商品贸易网络的运营平台。真正的分歧在于：2025 年利润增长是全球数贸中心开业和配套物业释放带来的一次性台阶，还是公司从市场租金走向贸易基础设施平台的开始。"
        },
        {
          title: "资产颗粒度",
          content: "一区到五区是第五代市场的成熟现金牛，但价值并不相同：一区有玩具、饰品、仿真花等高外向度心智入口；二区承接箱包、五金、小家电和电子仪表等耐用品；四区体量最大，是日用百货、袜类、鞋类等基础盘；五区兼具进口、电商服务和新业态承接。六区/全球数贸中心是成长试验场，七区或后续扩展暂不计入基础估值。"
        },
        {
          title: "铺位溢价",
          content: "义乌购前 10 页转租转让样本显示，老市场核心商位存在从数十万元到数百万元甚至更高的公开报价，说明商户把好位置未来经营利润资本化。六区样本价格分化更大，低价和个别高价并存，反映新市场仍处价格发现期。"
        },
        {
          title: "竞争与护城河",
          content: "核心参照是海宁皮城。海宁皮城绑定相对单一的皮革服装市场，2025 年收入和利润继续承压；小商品城的强点在于多品类、外贸心智、城市级配套和数字贸易延伸。护城河评级为中等偏宽、正在变宽，但仍需六区和平台化利润验证。"
        },
        {
          title: "估值纪律",
          content: "按 2025 年 42.04 亿元归母净利润和 12.17 元股价测算，当前 PE 约 15.9 倍。若可持续利润中枢为 36-42 亿元，当前接近传统 EPV 上沿；若六区和数字贸易把利润中枢推至 48-55 亿元，当前估值才更合理。新买入优先等待 9-10 元或经营数据升级。"
        }
      ],
      linkedModules: [],
      linkedIndustryId: null,
      markdownFile: "reports/yiwu-commodity-city-deep-report.md"
    }
  ]
};
