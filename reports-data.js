  ...
  reports: [
    ...
    },
    {
      ...
      keyEvidence: [
        ...
        "卡拉曼式清算折扣下AV约10-12元/股，EPV约20-22元/股；当前价格位于EPV以上的成长价值区间，安全边际不厚"
      ],
      sections: [
        {
          title: "核心矛盾",
        ...
        {
          title: "估值与买入纪律",
          content: "AV按卡拉曼式清算地板处理，不按账面净资产照搬：应收、存货、固定资产、商誉和品牌渠道均做压力折扣，保守AV约85-100亿元，对应10-12元/股；中性EPV约165-180亿元，对应20-22元/股。当前31.79元处于EPV+成长价值区间，22元以下接近保守区，26元以下较有吸引力。"
        },
        {
          title: "跟踪指标",
