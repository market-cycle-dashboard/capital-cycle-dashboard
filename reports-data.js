...
window.REPORTS_DATA = {
  ...
  reports: [
    ...
    },
    {
      ...
      status: "published",
      confidence: "中",
      conclusion: "五粮液仍是中国白酒里少数拥有全国高端品牌、浓香品类基本盘和超额现金资产的公司，但2025年业绩断崖、收入确认口径调整、董事长被留置共同说明，当前研究重点已从“品牌是否强”转向“治理和渠道真实库存能否重新变得可信”。86.87元/股更适合持有和等待验证，不是高安全边际买点。",
      keyEvidence: [
      ...
      sections: [
        ...
        {
          title: "估值与买入纪律",
          content: "五粮液2025年末每股净资产约30.90元，86.87元对应PB约2.81倍。保守AV约960-1020亿元，对应25-26元/股；基准修复EPV约49元/股，乐观修复EPV约62元/股。当前价格已经计入一部分ROE修复预期。50-60元是更舒服的买入区，60-70元是可研究分批区，70-90元以持有和等待验证为主。"
        },
        {
          title: "跟踪指标",
