  ...
  reports: [
    ...
    },
    {
      ...
      keyEvidence: [
        ...
        "盈峰睿和持股29.42%并成为控股股东，何剑锋为实际控制人；定增完成后盈峰集团及一致行动人持股比例拟升至37.37%",
        "沙发收入115.76亿元、卧室产品34.65亿元，是公司品牌心智和规模优势所在",
        "对比敏华控股和欧派家居，顾家2025年收入增长跑赢，但毛利率和净利率并非行业最高，护城河不能直接评为宽",
        "AV约11-13元/股，EPV约20-22元/股；当前价格位于EPV以上的成长价值区间，安全边际不厚"
      ],
      sections: [
        {
          title: "核心矛盾",
        ...
        {
          title: "管理层与控制权转折",
          content: "2024年盈峰睿和成为控股股东，何剑锋成为实际控制人；2025年收购报告书显示定增完成后盈峰集团及一致行动人持股比例拟升至37.37%。这给公司带来零售效率、供应链和资本纪律想象，但新控制人尚未经历完整周期检验，因此管理层评级为条件信任。"
        },
        {
          title: "竞争与护城河",
        ...
        {
          title: "估值与买入纪律",
          content: "保守AV约90-105亿元，对应11-13元/股；中性EPV约165-180亿元，对应20-22元/股。当前31.79元对应PB约2.36倍、PE TTM约13.16倍，处于EPV+成长价值区间。22元以下接近保守区，26元以下较有吸引力，30元以上需要成长兑现。"
        },
        {
          title: "跟踪指标",
