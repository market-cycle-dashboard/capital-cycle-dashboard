...
window.REPORTS_DATA = {
  ...
  reports: [
    ...
    },
    {
      ...
      status: "published",
      confidence: "中",
      conclusion: "健盛集团（603558）是全球规模最大的中高端棉袜 ODM 制造商之一，服务 Nike、Adidas、PUMA 等顶级品牌，毛利率 30.2%、ROE 16.5%、净利润三年翻倍。当前股价 13.71 元略高于 EPV（10.6 元），Q 公式均衡值区间 14.4-21.6 元，投资逻辑是「ROE 复利+成长」而非股息安全垫。最大风险是美国关税政策（含越南）和埃及工厂执行不确定性。当前不是最佳买点，回落至 EPV 附近（10-11 元）才具备深度安全边际。",
      keyEvidence: [
      ...
      sections: [
        {
          title: "核心矛盾",
          content: "市场将健盛视为普通纺织代工股，给出12倍PE，但公司实际上拥有真实的B2B护城河：Nike/Adidas的10年+合作关系、产业链垂直整合降低15%成本、三国产能灵活应对关税。EPV约10.6元/股，当前13.71元已溢价于EPV，市场在为成长买单。问题是：埃及工厂能否顺利投产？越南关税政策是否有变数？"
        },
        {
          title: "竞争与护城河",
